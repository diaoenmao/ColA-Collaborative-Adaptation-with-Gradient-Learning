...
class LoraLayer:
    ...
    def reset_lora_parameters(self, adapter_name):
        if adapter_name in self.lora_A.keys():
            ...
            # self.lora_A[adapter_name].weight.data = torch.arange(self.lora_A[adapter_name].weight.numel()).float().view(self.lora_A[adapter_name].weight.size()) /self.lora_A[adapter_name].weight.numel()
            nn.init.zeros_(self.lora_B[adapter_name].weight)
