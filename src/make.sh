...
python make.py --mode peft --task_name clm --run train --num_experiment 1 --resume_mode 1 --init_seed 0 --round 8 --split_round 3
python make.py --mode peft --task_name clm --run test --num_experiment 1 --resume_mode 1 --init_seed 0 --round 8 --split_round 3
...
python make.py --mode cola_step --task_name clm --run train --num_experiment 1 --resume_mode 1 --init_seed 0 --round 8 --split_round 1
python make.py --mode cola_step --task_name clm --run test --num_experiment 1 --resume_mode 1 --init_seed 0 --round 8 --split_round 1
